		...
		<div className="flex min-h-screen flex-col">
			...
			<div className="flex flex-1">
				...
				<main className="flex flex-1 flex-col">
					...
					<div className="bg-background/95 supports-[backdrop-filter]:bg-background/60 border-border/40 sticky top-0 z-40 border-b px-2 py-2 backdrop-blur">
				...
				{isLargeScreen && (
					<aside className="sticky top-4 h-[calc(100vh-6rem)] w-90 flex-shrink-0 self-start px-2">
						<ConfigAside
							config={generatedConfig}
