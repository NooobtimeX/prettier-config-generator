...
export function ConfigAside({ config, onReset, hasConfig }: ConfigAsideProps) {
	...
	return (
		<div className="bg-background/95 supports-[backdrop-filter]:bg-background/60 relative flex min-h-screen flex-col overflow-hidden rounded-lg border-l backdrop-blur">
			{/* Sticky Header */}
			...
			<div className="flex min-h-0 flex-1 flex-col overflow-auto">
				{hasConfig && displayConfig ?
					<>
						...
						<div className="bg-background/95 sticky bottom-0 z-10 mb-4 shrink-0 rounded-b-lg border-t p-2 backdrop-blur">
							<Button
								variant="outline"
